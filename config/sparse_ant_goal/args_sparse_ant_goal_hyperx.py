...
def get_args(rest_args):
    ...
    parser.add_argument('--weight_exploration_bonus_vae_error', type=float, default=0.01)
    ...
    #  for ant-goal, we only incentivise exploring the (x,y) plane
    parser.add_argument('--state_expl_idx', nargs='+', type=int, default=[0, 1],
