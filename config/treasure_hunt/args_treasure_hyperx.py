...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='TreasureHunt-v0', help='environment to train on')
    ...
    parser.add_argument('--norm_actions_post_sampling', type=boolean_argument, default=False,
                        help='normalise policy output')
    parser.add_argument('--norm_rew_clip_param', type=float, default=100, help='rew clip param')
    ...
    parser.add_argument('--latent_dim', type=int, default=25, help='dimensionality of latent space')

    # - decoder: rewards
    parser.add_argument('--decode_reward', type=boolean_argument, default=True, help='use reward decoder')
    parser.add_argument('--normalise_rew_targets', type=boolean_argument, default=True,
                        help='divide reward targets by largest rew seen')
    parser.add_argument('--rew_loss_coeff', type=float, default=0.01, help='weight for state loss (vs reward loss)')
    ...
    parser.add_argument('--weight_exploration_bonus_hyperstate', type=float, default=1.0)
    ...
    parser.add_argument('--rnd_buffer_size', type=int, default=10000)
    ...
    # other settings
    parser.add_argument('--intrinsic_rew_clip_rewards', type=float, default=None)
