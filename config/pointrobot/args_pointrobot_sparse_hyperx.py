...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='hyperx', help='label for the experiment')
    ...
    parser.add_argument('--normalise_rew_targets', type=boolean_argument, default=False,
    ...
    parser.add_argument('--weight_exploration_bonus_hyperstate', type=float, default=0.01)
    ...
    parser.add_argument('--weight_exploration_bonus_vae_error', type=float, default=0.1)
