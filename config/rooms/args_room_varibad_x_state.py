...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='varibad_x_state', help='label (typically name of method)')
    ...
    parser.add_argument('--save_interval', type=int, default=250, help='save interval, one save per n updates')
